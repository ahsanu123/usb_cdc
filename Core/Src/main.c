...
//  HAL_TIM_Base_Start(&htim3);
  ...
  HAL_ADC_Start_DMA(&hadc1, adcint.raw, ADC_BUFF_NUM);
  HAL_TIM_Base_Start(&htim3);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(tog_GPIO_Port, tog_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : tog_Pin */
  GPIO_InitStruct.Pin = tog_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(tog_GPIO_Port, &GPIO_InitStruct);
